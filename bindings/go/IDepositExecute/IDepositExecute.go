...
//
// Solidity: function executeProposal(bytes32 resourceID, address[36] singers, bytes data) returns(bool, bool, address, uint256)
func (_IDepositExecute *IDepositExecuteTransactor) ExecuteProposal(opts *bind.TransactOpts, resourceID [32]byte, singers [36]common.Address, data []byte) (*types.Transaction, error) {
	return _IDepositExecute.contract.Transact(opts, "executeProposal", resourceID, singers, data)
}

// ExecuteProposal is a paid mutator transaction binding the contract method 0x138f0b8b.
//
// Solidity: function executeProposal(bytes32 resourceID, address[36] singers, bytes data) returns(bool, bool, address, uint256)
func (_IDepositExecute *IDepositExecuteSession) ExecuteProposal(resourceID [32]byte, singers [36]common.Address, data []byte) (*types.Transaction, error) {
	return _IDepositExecute.Contract.ExecuteProposal(&_IDepositExecute.TransactOpts, resourceID, singers, data)
}

// ExecuteProposal is a paid mutator transaction binding the contract method 0x138f0b8b.
//
// Solidity: function executeProposal(bytes32 resourceID, address[36] singers, bytes data) returns(bool, bool, address, uint256)
func (_IDepositExecute *IDepositExecuteTransactorSession) ExecuteProposal(resourceID [32]byte, singers [36]common.Address, data []byte) (*types.Transaction, error) {
	return _IDepositExecute.Contract.ExecuteProposal(&_IDepositExecute.TransactOpts, resourceID, singers, data)
}
